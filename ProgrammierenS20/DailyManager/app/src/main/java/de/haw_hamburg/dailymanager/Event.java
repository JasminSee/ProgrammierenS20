...
public class Event {
    ...
    public Event(String eventName, String location, String note, String remindOption) {
        this.eventName = eventName;
    ...
    public void setTime(Calendar startTime) {
        this.startTime = startTime;
    }
    ...
    public void setReminder(String remindOption) {
        this.remindOption = remindOption;
    }
