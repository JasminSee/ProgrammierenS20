    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String reminder = spinner.getSelectedItem().toString();
                Event myEvent = new Event(eventName, location, note, reminder);

                WriteService.writeObject(AddEntryActivity.this, myEvent);
                //Log.i("Event: ", "Name: " + eventName + ", Location: " + location + ", Note: "
                //        + note + min + ", Time: " + getTime + ", Erinnerung: " + reminder);
            }
        });
    }
}
